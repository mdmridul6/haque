...
<body>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="{{asset('frontend/assets/img/logo.png')}}" class="logo logo-display" alt="Logo">
                    </a>
                </div>
    ...
    <!-- Start Breadcrumb
    ============================================= -->
    <div class="breadcrumb-area shadow dark bg-fixed text-center padding-xl text-light" style="background-image: url({{asset('frontend/assets/img/2440x1578.png')}});">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Blog Single</h1>
                                            ...
                                            <div class="commen-item">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="comments-info">
                                                        July 15, 2019 <a href="#"><i class="fa fa-reply"></i>Reply</a>
                                                    </div>
                                                    <p>
